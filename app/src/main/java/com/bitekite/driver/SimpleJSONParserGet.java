...
class DataLoader {
    ...
    public HttpResponse secureLoadData(String url, ArrayList<NameValuePair> nameValuePairs)
        ...
        HttpConnectionParams.setConnectionTimeout(httpParameters, SimpleJSONParserGet.TIMEOUT_CONNECTION);
